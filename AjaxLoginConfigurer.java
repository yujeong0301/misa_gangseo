...
import kr.co.misa.mvc.service.security.filter.AjaxLoginProcessingFilter;
...
/**
 * author : 박윤재
 * 기능 : ajax dsls, 한곳에 여러설정이나 관련 속성이나 값들을 모아서 처리하는 페이지, spring docs 에서 가져옴
 **/
final class AjaxLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
